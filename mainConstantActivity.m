...
activityModel = (activityModel./activityModel) * 14.4;
...
%plotCommand = 'growth|delta|zscore|difference|fatmass|gas|energy|xFluxes|subsystems|intFluxes|foodUtilization|nitrogen|fatfix|height';
plotCommand = 'growth|fatmass|zscore|height';
