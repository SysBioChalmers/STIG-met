...
referenceData = makeReferenceObject('referenceData/weightBoy.txt', 'referenceData/multiCenterData.txt', 'referenceData/zScoreBoy.txt', 'referenceData/heightBoy.txt');
...
activityModel = makeActivityModel('data/activityModel.txt', 15);
...
individual{4} = createIndividual('OverFed', true, 0, initWeigth, initFat, growthLean, growthFat, maintainLean, maintainFat, activityModel, uptakeFactor, fatModel);
...
individual{5} = createIndividual('UnderFed', true, 0, initWeigth, initFat, growthLean, growthFat, maintainLean, maintainFat, activityModel, uptakeFactor, fatModel);
simulationResults{5} = runSimulation(individual{5}, simSettings, foodModel4);

%Over Active
individual{6} = createIndividual('OverActive', true, 0, initWeigth, initFat, growthLean, growthFat, maintainLean, maintainFat, 2 * activityModel, uptakeFactor, fatModel);
...
plotCommand = 'growth|zscore|fatmass|height';
