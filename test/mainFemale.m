...
referenceData = makeReferenceObject('referenceData/weightFemale.txt', 'referenceData/multiCenterDataFemale.txt');
...
individual{1} = createIndividual('Healthy Female', true, 0, 3232, 0.13 * 3232, 5.5, 1.6, 59, 5, activityModel, (1-0.07), fatModel);
